...
<div class="row"> <!--  ------------------------  START CONTENT      ------------------------      -->
	...
	<h1>
		...
		Manage Interactive Course Parts
	</h1>
	</div>
	<style>
		.pagination li {
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div id="test-list">
			...
			<?php
				...
				$query_select_mycourse= "SELECT id, title, sdescription FROM tbl_courses WHERE create_uid=".$_SESSION['USERID']." AND course_item_id=3 GROUP BY title";
				...
				while($row = $result_select_mycourse->fetch_array()){
					...
					{
						$table_data .="<td class=\"right\"><a href=\"courses.php?id=".$row[0]."&citem=3\"><i class=\"glyphicon glyphicon-pencil\"></i></a>&nbsp;<a href=\"#\"><i class=\"glyphicon glyphicon-remove\"></i></a></td></tr>";
					}
