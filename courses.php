 <?php 
	...
	else if($_POST["action"] == "upd")
	{
		...
		if($_GET["citem"]==3)
		{
			$query_update = "UPDATE tbl_courses SET title='".mysql_real_escape_string($_POST["title"])."',sdescription='".mysql_real_escape_string($_POST["sdescription"]).
			"',content='".mysql_real_escape_string($_POST["content"])."',author='".$_POST["author"]."', modify_date=NOW(),publisher='".$_POST["publisher"].
		...
		{
			$query_update = "UPDATE tbl_courses SET title='".mysql_real_escape_string($_POST["title"]).
