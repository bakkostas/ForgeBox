...
<div class="row"> <!--  ------------------------  START CONTENT      ------------------------      -->
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<a id="link_widget1" href="#" class="widget widget_id_2" data-atr_id="2" data-atrarrposition="1" onclick="window.location='add_course_category.php';">
	...
	<script>
		...
		var link = 'functions/select_cat_courses.php';//?citem='+citem;
		...
		{				
			...
			$.ajax({
				type: "POST",
				url: "functions/activate_course_category.php",
					...
					if(msg.status == 1){
						if(msg.txt=="Deactivate")
						{
							...
							*/
							...
							$('#table_cat').load('functions/select_interactive_categories.php').fadeIn("slow");
						}
